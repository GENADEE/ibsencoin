...
#params:
#inputs: a list of unspent outputs. The format of an unspent output is a tuple of the format (transaction, key), where transaction is the hash of a complete signed, confirmed, transaction in the blockchain, and key is the public key associated with the ouput of that transaction to be spent.
...
class wallet:
  def __init__(self, keyfile_name, pool_request, post_transaction, get_value, listen, denominations = ((1), 2 ,16 ), backupdir=None, swapdir=None):
